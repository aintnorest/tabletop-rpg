...
A Tier 2, Size 1 character uses Reposition (2" base distance) on a Tier 3, Size 2 enemy. The target is 1 size larger (-1") and 1 Tier higher (-1"), reducing the distance to 0". The Reposition fails and the target does not move.
